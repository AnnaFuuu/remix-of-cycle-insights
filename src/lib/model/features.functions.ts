...
export interface FeatureDef {
  key: string;
  label: string;
  group: "Label" | "Endocrine" | "Anthropometric" | "HRV" | "Sleep" | "Sleep score" | "Resting HR" | "Respiratory" | "Wrist temp" | "Stress" | "Glucose" | "Self-report";
  source: string;
  description: string;
}
...
export const FEATURE_DEFS: FeatureDef[] = [
  ...
  { key: "wrist_temp_daily_mean",     label: "Wrist temp daily mean (Δ°C)",    group: "Wrist temp",    source: "wrist_temperature",         description: "Daily mean of minute-level wrist temperature deviation from participant baseline." },
  { key: "wrist_temp_overnight_mean", label: "Wrist temp overnight (Δ°C)",     group: "Wrist temp",    source: "wrist_temperature",         description: "Overnight (00:00-06:00) mean wrist temperature deviation from baseline." },
  { key: "wrist_temp_samples",        label: "Wrist temp samples (min)",       group: "Wrist temp",    source: "wrist_temperature",         description: "Number of valid minute-level wrist temperature readings that day." },
